...
public class RecipeProvider extends FabricRecipeProvider {
    ...
    private static final List<ItemConvertible> PARAGONIUM_EQUIPMENT = List.of(DANDYCORPItems.PARAGONIUM_HELMET, DANDYCORPItems.PARAGONIUM_CHESTPLATE,
            DANDYCORPItems.PARAGONIUM_LEGGINGS, DANDYCORPItems.PARAGONIUM_BOOTS, DANDYCORPItems.PARAGONIUM_SWORD, DANDYCORPItems.PARAGONIUM_PICKAXE, DANDYCORPItems.PARAGONIUM_AXE,
            DANDYCORPItems.PARAGONIUM_SHOVEL, DANDYCORPItems.PARAGONIUM_HOE, DANDYCORPItems.PARAGONIUM_BOW, DANDYCORPItems.PARAGONIUM_SHIELD);
...
//        offerBlasting(exporter,CHROMIUM_EQUIPMENT,RecipeCategory.MISC, DANDYCORPItems.CHROMIUM_NUGGET,0.1f,100,"chromium");
        ...
        offerSmelting(exporter,PARAGONIUM_EQUIPMENT,RecipeCategory.MISC, DANDYCORPItems.CHROMIUM_NUGGET,0.2f,200,"paragonium");
        offerBlasting(exporter,PARAGONIUM_EQUIPMENT,RecipeCategory.MISC, DANDYCORPItems.CHROMIUM_NUGGET,0.1f,100,"paragonium");
    }
}
