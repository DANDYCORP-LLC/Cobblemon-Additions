...
public class DANDYCORPDamageTypes {
    ...
    public static final RegistryKey<DamageType> HAIL_MARY_EXPLOSION = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, new Identifier("dccobblemon", "hail_mary_explosion"));
    public static final RegistryKey<DamageType> HAIL_MARY_DIRECT_HIT = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, new Identifier("dccobblemon", "hail_mary_direct_hit"));
